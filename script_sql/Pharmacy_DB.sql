...
CREATE TABLE DonHang (
                         ...
                         tongTien MONEY NULL,
                         tinhTrang BIT, -- Sửa kiểu dữ liệu Boolean thành BIT
                         FOREIGN KEY (idSanPham) REFERENCES SanPham(id),
...
',N'Uống mỗi ngày 1 chai, uống trực tiếp, tốt nhất là uống lạnh.', N'TP001'),
    ('SP009', N'Bột uống FERROLIP bổ sung sắt (Hộp 20 gói)', 230000, 'https://production-cdn.pharmacity.io/digital/768x768/plain/e-com/images/ecommerce/20240528064014-0-P28033_1.jpg', 900, 600, 300, N'bổ sung sắt',N'Ngày hết hạn để chỉ sản phẩm được bảo quản đúng cách, trong bao bì nguyên vẹn. Không sử dụng quá liều khuyến cáo.',N'chứa: Sắt (sắt pyrophosphate được bao vi nang) 30mg
